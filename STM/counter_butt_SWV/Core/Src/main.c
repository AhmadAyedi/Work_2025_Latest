...
uint8_t lastButtonState = 0;   // Last button state
volatile uint32_t counter = 0; // Global counter (volatile for SWV tracing)         // Counter variable
...
/* USER CODE BEGIN PFP */
void ITM_SendString(char *str); // Function to send string via ITM
...
{
  /* USER CODE BEGIN 1 */
	char buffer[32]; // Buffer for formatting counter value
  /* USER CODE END 1 */
