...
linSerial = serial.Serial('/dev/serial0', baudrate=9600, timeout=0.1)  # Adjusted timeout for faster response
    ...
    while True:
        ...
        if linSerial.in_waiting > 0:
            try:
                ...
                print("Error: Received invalid UTF-8 data. Skipping this frame.")
